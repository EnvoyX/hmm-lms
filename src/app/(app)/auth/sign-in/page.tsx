      ...
      <Form {...form}>
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel className="self-start text-primary font-medium">Email</FormLabel>
                <FormControl>
                  <Input
                    className=""
                    type="email"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel className="self-start text-primary font-medium">Password</FormLabel>
                <FormControl>
                  <div className="relative items-center flex">
                    <Input className="" type={showPassword ? 'text' : 'password'} {...field} />
                    {showPassword ? (
                      <FiEye
